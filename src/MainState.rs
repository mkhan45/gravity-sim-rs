...
pub struct MainState {
    ...
    pub paused: bool,
    pub predict_body: Body,
    pub predict_speed: usize,
...
impl event::EventHandler for MainState {
    fn update(&mut self, ctx: &mut Context) -> GameResult {
        ...
        input_helper::process_input(&ggez::input::keyboard::pressed_keys(ctx), self);       
    ...
    fn mouse_wheel_event(&mut self, _ctx: &mut Context, _x: f32, y: f32) { 
        self.zoom *= 1.0 + (y * 0.1); 
        self.zoom = ((self.zoom * 100000.0).round())/100000.0; //rounds to 5 digits
    }
    ...
    //        input::keyboard::KeyCode::G => self.bodies.append(&mut presets::grid(&self.offset, &self.radius, &self.density, &self.zoom)),
